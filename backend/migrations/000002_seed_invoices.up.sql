-- Seed fixture invoices so a fresh database (local first run, or first
-- deploy) has data to look at immediately. Runs once: golang-migrate
-- records this file in schema_migrations, so it never re-applies.
