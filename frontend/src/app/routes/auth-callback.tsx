 ...
 * handler sends the browser to `/auth/callback#token=...&expiresAt=...`.
 * Stores the token and bounces straight to the app; there's nothing to see
 * here in the success path.
 */
